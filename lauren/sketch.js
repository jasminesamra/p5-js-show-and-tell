...
function setup() {
  ...
  describe(
    'gratitude! starts off small at the initial meetup, ends up infinite as you make more and more memories with your loved ones and in life!'
  );
}
...
class Boid {
  constructor(x, y) {
    ...
    if (random() < 0.5) {
      // Red to orange range (0 to ~50)
      warmHue = random(0, 50);
    } else {
      // Pink range (wraps around, near max hue)
      warmHue = random(230, 255);
    }

    this.color = color(warmHue, 255, 255);
  }
